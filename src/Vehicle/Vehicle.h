...
public:
    ...
    Q_PROPERTY(FactGroup*           fuel            READ fuelFactGroup              CONSTANT)
    ...
    */
    ...
    FactGroup* fuelFactGroup                () { return &_fuelFactGroup; }
...
private:
    ...
    VehicleFuelFactGroup            _fuelFactGroup;
    ...
    static const char* _fuelFactGroupName;
